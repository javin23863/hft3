...
|---|---|---|---|---|
| Q001 | What exact CME futures/options historical datasets are available for full universe research after the lane split? | F001, F002, F005 | Full model-universe claims require real coverage, not assumed coverage. | Data inventory with symbols, dates, venues, fields, and gaps. |
