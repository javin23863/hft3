...
The current documented scoreboard is `346/346 passing` across 26 test files in `docs/hft3_autonomous_pipeline_runbook.md` and `docs/hft3_traceability.md`. Phase 25 required-test closure is concrete and complete.
