...
This runbook documents the autonomous research runner and the 26 completed phases of the 26-phase hardening spec.
...
```bash
python -m pytest tests/test_autonomous_runner.py tests/test_autonomous_runner_recovery.py tests/test_phase25_required_tests.py tests/test_runner_honesty.py -v
```

## 16. Test results

35/35 passing (11 runner tests + 13 recovery tests + 5 Phase 25 validation tests + 6 honesty guard tests).
...
| 25 — Required tests and validation matrix | ✅ DONE | `tests/test_phase25_required_tests.py` |
| 26 — Documentation | ✅ DONE | `bb87c1b` and `8149cd7` |

## Test scoreboard

**352/352 passing** across 26 test files:
...
- `tests/test_workbench/test_phase5_trade_audit.py` (10 tests)
- `tests/test_workbench/test_robustness_pack_phase9.py` (12 tests)
- `tests/test_defensive_model.py` (16 tests)
- `tests/test_gate_schema.py` (14 tests)
...
- `tests/test_workbench/test_double_wf.py` (16 tests)
