...
_PDF_SIGNAL_PRIMARIES = frozenset({"PDF_MODEL_8", "PDF_MODEL_10", "PDF_MODEL_2", "PDF_MODEL_6"})
...
class CompositionOrchestrator:
    ...
    def _apply_stub(
        ...
        if stub.model_id.startswith("PDF_MODEL_"):
            ...
            if out and out.payload is not None:
                ...
                if phase == "continuous" and stub.model_id == "PDF_MODEL_3":
