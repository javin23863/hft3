...
def test_parse_continuous_lane_profile_returns_family() -> None:
    ...
    assert profile.relationship_family == entry["valid_relationship_types"][0]
...
def test_event_parse_ignores_continuous_slug_in_parens() -> None:
    ...
    assert parsed.primary_model_id != "MICRO_STANDARD_FLOW_TRANSFER"
