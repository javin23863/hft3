"""T0: deterministic fill lifecycle via HftBacktest adapter."""
...
def test_submit_accept_fill_lifecycle(minimal_npz_tmp) -> None:
    from backtest_pipeline.src.hft_backtest_builder import build_hftbacktest

    hbt = build_hftbacktest(str(minimal_npz_tmp), latency_ms=1.0)
