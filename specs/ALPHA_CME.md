...
| M1 | **`decision_runtime` hardening** — `evaluate_actions` writes all 10 slots every call; slots 3–9 receive `NEG_INFINITY_SENTINEL`; header validation tests pass; CORRECTNESS.md §3 defect (a) cleared. | Laptop | CHI404_RUNTIME.md §4; CORRECTNESS.md §3 defect a | **OPEN** | — |
