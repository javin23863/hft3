...
def write_report(
    ...
    payload = {
        ...
        "broker_call_count": (lifecycle_summary or {}).get("broker_call_count", 0),
        ...
        "backtest_latency_note": "Replay uses HftBacktestSimulatedExchangeAdapter; broker ack is measured separately",
