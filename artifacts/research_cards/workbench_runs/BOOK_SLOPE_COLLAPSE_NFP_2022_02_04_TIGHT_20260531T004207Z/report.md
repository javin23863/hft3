# Workbench Run Report: SECOND_WAVE_CONTINUATION1

- **Event / period:** NFP_2022_02_04_TIGHT (NFP_2022_02_04_TIGHT)
- **Latency authority:** C++ measured (Python runtime informational only)

## Runtime (do not conflate)

- **Python research runtime:** 249955221.0 µs (informational only)
...
- **Simulated latency-adjusted PnL:** $161.53
