# Workbench Run Report: SECOND_WAVE_CONTINUATION0

- **Event / period:** CPI_2025_09_11_TIGHT (CPI_2025_09_11_TIGHT)
- **Latency authority:** C++ measured (Python runtime informational only)

## Runtime (do not conflate)

- **Python research runtime:** 473274107.9 µs (informational only)
...
- **Simulated latency-adjusted PnL:** $143.13
- **Survives C++ execution delay:** True
