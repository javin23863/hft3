...
## Corpus Check
- 1811 files · ~862,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28569 nodes · 37812 edges · 2597 communities (2254 shown, 343 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2213 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28c9dfd5`
...
2. `Point` - 145 edges
3. `Point` - 114 edges
4. `ModelComposition` - 96 edges
5. `BaseHypothesis` - 86 edges
6. `BaseStructuralModel` - 86 edges
7. `ModelOutput` - 84 edges
8. `HypothesisRegistry` - 82 edges
9. `OrderBook` - 72 edges
10. `MBOEvent` - 69 edges
...
- `float` --uses--> `MarketStatePipeline`  [INFERRED]
  decision_engine/python/src/feature_store.py → features_engine/src/pipeline/market_state_pipeline.py
- `Path` --uses--> `LegQuote`  [INFERRED]
  tests/test_parity_ingest.py → options_lane/src/models.py
- `Exception` --uses--> `DatabentoConverter`  [INFERRED]
  workbench/src/data/catalog_backfill.py → backtest_pipeline/src/converter.py
...
## Communities (2597 total, 343 thin omitted)
...
Cohesion: 0.06
Nodes (77): Any, bool, _check_cmdline_tokens(), _check_cpupower_idle(), _check_cyclictest_p99(), _check_irq_net(), _check_jitter_gate(), _check_manifest() (+69 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (45): signal_sample, 1, 10, 11, 12, 13, 14, 15 (+37 more)
...
Cohesion: 0.07
Nodes (26): authoritative_source, dominant_bottleneck, e2e_harness, reason, spec, status, gates, cyclictest_pass (+18 more)
...
Cohesion: 0.07
Nodes (29): Action, array, ActionValue, action, adverse_selection_ticks, expected_value, fill_probability, tail_risk (+21 more)
...
Cohesion: 0.09
Nodes (36): bool, float, int, str, MarketState, bool, float, int (+28 more)
...
Cohesion: 0.43
Nodes (7): array, string, apply_event_context_boosts(), clamp_nonneg(), RegimeFilterCpp(), reset(), update()
...
Cohesion: 0.16
Nodes (37): ArbFill, ParityBacktestResult, _PendingArb, Multi-leg parity arb backtest with latency deferral., float, bool, float, int (+29 more)

### Community 16 - "Community 16"
Cohesion: 0.33
Nodes (6): array, RegimeFilterCpp, prev_posterior_, reset, temperature_, update

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (24): _parse_comma_log_line(), _parse_csv_row(), _parse_export_timestamp(), _parse_log_line(), R|Trader export: timestamp,Trade,MES,5000.00,1, Watch R|Trader Pro export/log files (Wine on CHI404 only)., Watch R|Trader Pro export/log files (Wine on CHI404 only)., Parse R|Trader export prefix: 2026-05-30 01:00:00.000000 (+16 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (63): BaseHypothesis, str, AbsorptionFade, AggressorDecelerationFade, BaseHypothesis, BookSlopeCollapse, CancelStormBeforeMove, CutoffPanicExits (+55 more)
...
Cohesion: 0.12
Nodes (16): feed_latency_us, avg_us, count, max_us, min_us, p99_us, input_files, limitations (+8 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (22): CHI404 only (Chicago colo), code:block1 (data/raw/rithmic_trial_live_capture/YYYY-MM-DD/SYMBOL/), code:block10 (runtime/paper_latency/raw/<run_id>/records.ndjson   # monoto), code:bash (python3 scripts/latency_probe/summarize_latency.py --run-id ), code:bash (python -m data_system.rithmic_trial.pipeline replay-event \), code:bash (export RITHMIC_TRIAL_ENABLED=1), code:bash (EVENT_ID=CPI_2024_09_11_TIGHT bash scripts/chi404_run_trial_), code:bash (python -m data_system.rithmic_trial.pipeline replay-sample \) (+14 more)
...
Cohesion: 0.08
Nodes (28): DecisionEngine, FeatureExtractorCpp, MarketDataEvent, RiskManager, Config, MarketDataEvent, SPSCQueue, string (+20 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (22): 1. Think Before Coding, 2. Simplicity First, 3. Surgical Changes, 4. Goal-Driven Execution, CHI404 bare metal, hft3 Agent Charter, hft3-specific constraints, If the chain was skipped (+14 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (86): AuditActor, AuditDetail, AuditFilter, AuditOperation, AuditPage, AuditQueryOptions, AuditRecord, AuditStore (+78 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (15): chi404_measured_speed, backtest_latency_ms, backtest_latency_source, cpu_loaded_p99_us, gateway_ping_p99_ms, network_worst_p99_us, network_worst_source, order_ack_measured (+7 more)

### Community 29 - "Community 29"
Cohesion: 0.14
Nodes (14): HYP_1, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (14): HYP_10, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 31 - "Community 31"
Cohesion: 0.14
Nodes (14): HYP_11, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 32 - "Community 32"
Cohesion: 0.14
Nodes (14): HYP_12, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (14): HYP_13, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 34 - "Community 34"
Cohesion: 0.14
Nodes (14): HYP_14, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (14): HYP_15, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (14): HYP_17, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (14): HYP_18, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 38 - "Community 38"
Cohesion: 0.14
Nodes (14): HYP_19, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 39 - "Community 39"
Cohesion: 0.14
Nodes (14): HYP_2, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 40 - "Community 40"
Cohesion: 0.14
Nodes (14): HYP_21, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 41 - "Community 41"
Cohesion: 0.14
Nodes (14): HYP_22, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (14): HYP_23, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 43 - "Community 43"
Cohesion: 0.14
Nodes (14): HYP_24, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 44 - "Community 44"
Cohesion: 0.14
Nodes (14): HYP_26, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 45 - "Community 45"
Cohesion: 0.14
Nodes (14): HYP_28, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 46 - "Community 46"
Cohesion: 0.14
Nodes (14): HYP_29, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (14): HYP_3, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 48 - "Community 48"
Cohesion: 0.14
Nodes (14): HYP_30, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 49 - "Community 49"
Cohesion: 0.14
Nodes (14): HYP_4, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 50 - "Community 50"
Cohesion: 0.14
Nodes (14): HYP_42, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 51 - "Community 51"
Cohesion: 0.14
Nodes (14): HYP_43, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 52 - "Community 52"
Cohesion: 0.14
Nodes (14): HYP_44, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 53 - "Community 53"
Cohesion: 0.14
Nodes (14): HYP_5, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 54 - "Community 54"
Cohesion: 0.14
Nodes (14): HYP_8, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 55 - "Community 55"
Cohesion: 0.14
Nodes (14): HYP_16, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 56 - "Community 56"
Cohesion: 0.14
Nodes (14): HYP_25, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 57 - "Community 57"
Cohesion: 0.14
Nodes (14): HYP_35, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 58 - "Community 58"
Cohesion: 0.14
Nodes (14): HYP_27, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 59 - "Community 59"
Cohesion: 0.14
Nodes (14): HYP_41, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.14
Nodes (14): HYP_6, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 61 - "Community 61"
Cohesion: 0.14
Nodes (14): HYP_7, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 62 - "Community 62"
Cohesion: 0.14
Nodes (14): HYP_9, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 63 - "Community 63"
Cohesion: 0.14
Nodes (14): HYP_20, adverse_selection, alpha_family_or_discovered_behavior, approval_status, events_tested, expectancy, latency_bands, model_id (+6 more)

### Community 64 - "Community 64"
Cohesion: 0.13
Nodes (14): code:powershell (pip install graphifyy), code:powershell (graphify --version), code:powershell (.\scripts\graphify_pre_edit.ps1), code:powershell (.\scripts\graphify_rebuild.ps1), code:powershell (graphify update .), code:powershell (pip install openai   # graphify ollama backend uses OpenAI-c), code:powershell ($env:OLLAMA_API_KEY = 'local'), Graphify workflow (hft3) (+6 more)
...
Cohesion: 0.05
Nodes (40): reason, rtt_ms, source, status, cyclictest_p99_us, limit_us, max_p99_us, reason (+32 more)

### Community 71 - "Community 71"
Cohesion: 0.18
Nodes (10): cards, HYP_31, alpha_family_or_discovered_behavior, events_tested, latency_bands, model_id, net_pnl, queue_model (+2 more)
...
Cohesion: 0.20
Nodes (10): regime_posterior_sample, book_rebuild, chop, event_shock, liquidity_vacuum, normal, prop_flatten, spread_stress (+2 more)
...
Cohesion: 0.13
Nodes (15): classifications, colo_on_box, local_workstation, bottleneck, dominant_rtt_ms, recommendation, recommended_latency_bands_ms, tier_ms (+7 more)

### Community 80 - "Community 80"
Cohesion: 0.12
Nodes (17): reason, rtt_ms, source, status, complete_picture, chi404_tuning_run_id, legs, timestamp_utc (+9 more)
...
Cohesion: 0.10
Nodes (19): bottleneck, classification, recommendation, recommended_latency_bands_ms, tier_ms, tier_name, colo_only, dominant_rtt_ms (+11 more)
...
Cohesion: 0.11
Nodes (35): LiveCapture, FixtureConnector, Synthetic trial events for CI and offline pipeline tests., convert_to_npz(), _has_mbo(), Any, bool, float (+27 more)
...
Cohesion: 0.14
Nodes (29): build_models_config(), dependency_map(), get_model_by_id(), list_models(), _pdf_diagnostics_only(), _pdf_signal_field(), Load unified 55-model registry from YAML + hypothesis registry., Build all 55 model configs (44 HYP + 11 PDF). (+21 more)
...
Cohesion: 0.25
Nodes (8): SquareProbQueueModel, aggregated_net_pnl, approval_status, latency_bands_tested, model_id, queue_model, tail_risk_es_95, timestamp

### Community 90 - "Community 90"
Cohesion: 0.32
Nodes (5): datetime, str, ContractRollHandler, Resolves a continuous symbol (like MES.v.0) to a specific contract for a given d, Handles continuous contract resolution (e.g., MES.v.0 to MESZ4)     Ensures no d
...
Cohesion: 0.25
Nodes (8): deque, array, map, string, vector, BookLevelCpp, orders, total_qty
...
Cohesion: 0.08
Nodes (20): int, LateCandleEntryFade, NoOvernightInventorySqueeze, OneSidedAddCancelImbalance, PriorHighLowBreakoutTrap, Hypothesis 26: Late candle entry fade, Hypothesis 15: One-sided add/cancel imbalance, Hypothesis 22: Prior high/low breakout trap (+12 more)

### Community 101 - "Community 101"
Cohesion: 0.29
Nodes (6): exe_path, note, platform, rithmic_environment, rithmic_gateway, watch_dirs
...
Cohesion: 0.18
Nodes (11): latency_summary, avg_ms, host, max_ms, mdev_ms, min_ms, gateway_ping, note (+3 more)
...
Cohesion: 0.06
Nodes (92): build_report_card(), _fmt_ms_from_us(), _fmt_us(), _gate_status(), _md_table(), Fixed report card schema and renderers for CHI404 latency probes., Render latency summary as a fixed-section markdown report., Fixed-width console report (same sections every run). (+84 more)
...
Cohesion: 0.13
Nodes (15): avg_us, count, max_us, min_us, p99_us, rithmic_trial_profile, connector, data_capture_report (+7 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (29): MultiLegParityBacktester, write_research_card(), OptionsFeeModel, Per-leg fees keyed by group tick_size / leg count — no hardcoded products., Ingest helpers for options parity lane., load_quote_ndjson(), Load quote fixtures for parity lane., cmd_backtest() (+21 more)
...
Cohesion: 0.08
Nodes (47): str, _as_datetime(), _candidate_download_symbols(), download_events(), estimate_download_cost_usd(), _is_symbology_error(), missing_for_campaign(), Point-in-time Databento event-window download (never multi-year range). (+39 more)
...
Cohesion: 0.13
Nodes (23): 1. Macro event replay (primary research), 2. Single-hypothesis drill-down, 3. Full hypothesis matrix (offline sweep), 4. Rithmic trial live (CHI404 only), 5. Legacy / smoke only (do not use for macro research), 6. Microstructure workbench (unified 51-model research), code:bash (python scripts/run_event_replay.py \), code:bash (bash scripts/chi404_run_trial_smoke.sh   # fixture export on) (+15 more)

### Community 126 - "Community 126"
Cohesion: 0.05
Nodes (43): bytes, Response, main(), int, main(), int, main(), int (+35 more)

### Community 140 - "Community 140"
Cohesion: 0.29
Nodes (7): loopback_tcp, avg_ms, count, max_ms, min_ms, stdev_ms, target

### Community 141 - "Community 141"
Cohesion: 0.33
Nodes (5): detected_event_types, events_captured, status, uptime_sec, watch_dirs
...
Cohesion: 0.33
Nodes (6): vector, EventContextEngineCpp, events_, map_label, resolve_ns, ParsedEvent
...
Cohesion: 0.29
Nodes (7): production_operating_tier, gateway_rtt_ms, reason, recommended_latency_bands_ms, status, tier_ms, tier_name

### Community 166 - "Community 166"
Cohesion: 0.06
Nodes (30): campaign_id, composition, defensive_stubs, primary_model_id, events_ran, model_id, overfit_risk, param_hash (+22 more)
...
Cohesion: 0.13
Nodes (25): Path, str, Any, bool, int, Path, str, TrialConfig (+17 more)
...
Cohesion: 0.10
Nodes (20): breakeven_ms, data_period, event_id, lane_measured, lane_pass, lane_required, latency_buffer_ms, measured_p99_ms (+12 more)
...
Cohesion: 0.06
Nodes (54): AngleTable, chain2(), comb2(), DistanceTable, div(), fix(), fix_v(), frac_string() (+46 more)
...
Cohesion: 0.83
Nodes (3): chi404_vm_vnc_install.sh script, click(), key()
...
Cohesion: 0.40
Nodes (4): chi404_run_trial_live.sh script, RITHMIC_TRIAL_CONNECTOR, RITHMIC_TRIAL_ENABLED, RTRADER_WATCH_DIRS

### Community 199 - "Community 199"
Cohesion: 0.83
Nodes (3): Invoke-RtraderLoginAttempt(), Test-LoggedInTitle(), Write-SessionState()
...
Cohesion: 0.40
Nodes (4): chi404_vm_live_gate.sh script, RITHMIC_TRIAL_CONNECTOR, RITHMIC_TRIAL_ENABLED, RTRADER_WATCH_DIRS
...
Cohesion: 0.20
Nodes (10): event_accurate_mbo, all_hypotheses, description, engine, feature_path, hypotheses_with_trades, hypothesis_count, signal_threshold (+2 more)
...
Cohesion: 0.29
Nodes (7): engines, hftbacktest_loop, aggregation, description, engine, feature_path, signal_threshold

### Community 221 - "Community 221"
Cohesion: 0.10
Nodes (30): Resolve built C++ binaries under repo build/., Find hft_* executable under build/ (Release/Debug or flat)., resolve_cpp_binary(), Backward-compatible aliases — use cpp_stack_verify for new code., CppStackVerifyHarness, CppStackVerifyResult, get_cached_stack_verify(), C++ production stack verify gate (approach 3 prerequisite — not NPZ replay). (+22 more)
...
Cohesion: 0.07
Nodes (85): apply_derivations(), bfs_one_level(), cache_match(), create_consts_str(), diff_point(), do_algebra(), intersect1(), match_all() (+77 more)
...
Cohesion: 0.06
Nodes (31): Graph, Add a new parallel or collinear predicate., Check if the angle is equal to a certain constant., Check if an angle has a constant value., Check if two angles are equal., Check whether a ratio is equal to some given constant., Check whether a ratio is equal to some constant., Check if 8 points make an eqratio predicate. (+23 more)

### Community 232 - "Community 232"
Cohesion: 0.04
Nodes (65): get_proof_steps(), Extract proof steps from the built DAG., Run DD until saturation or goal found., Alternate between DD and AR until goal is found., saturate_or_goal(), solve(), Clause, compare_fn() (+57 more)

### Community 233 - "Community 233"
Cohesion: 0.06
Nodes (34): Make that two nodes x and y are equal, i.e. merge their value node., Add a new predicate that 4 points (2 lines) are parallel., Get or create an angle between two Direction d1 and d2., Maybe add a new parallel predicate from perp predicate., Add a new perpendicular predicate from 4 points (2 lines)., Get or create a Segment object between two Points p1 and p2., Add that two segments (4 points) are congruent., Maybe add a new cyclic predicate from given congruent segments. (+26 more)
...
Cohesion: 0.17
Nodes (12): trial_order_ack_appendix, authoritative, connector, limitations, note, populate_hint, profile_date, profile_path (+4 more)
...
Cohesion: 0.03
Nodes (83): L3Loader, LoaderReport, Wrap NPZ feed with sequence/timestamp quality checks., DatasetManifest, Dataset manifest and history sufficiency gate., LatencyViability, LatencyPolicy, LatencyViability (+75 more)
...
Cohesion: 0.14
Nodes (22): createRestErrorResponse(), extractErrorCode(), mapCodeToCategory(), mapErrorToHttpStatus(), RestErrorOptions, wrapErrorToRest(), generateActionRoute(), generateAggregateRoute() (+14 more)
...
Cohesion: 0.05
Nodes (73): BatchEvalResult, main(), server, ClientConnInterface, Duration, Env, EnvOption, Evaluator (+65 more)

### Community 257 - "Community 257"
Cohesion: 0.29
Nodes (6): Algorithmic Trading Strategy Development, Chicago Futures Hot-Memory Universe (market-state layer), Full PDF bundle (after-action citation index), HFT Framework Developer Prompt, Reference documents, Ultra-Low Latency Vector Search and HFT Engine Architecture
...
Cohesion: 0.20
Nodes (8): QueueSnapshot, QueueTracker, Queue position proxy for ReplayRunner path (MVP)., Log estimated queue rank at submit; fill prob = 1 / (1 + depth_ahead)., Any, float, int, str
...
Cohesion: 0.25
Nodes (8): operating_tier, bottleneck, dominant_rtt_ms, recommendation, recommended_latency_bands_ms, source, tier_ms, tier_name

### Community 278 - "Community 278"
Cohesion: 0.29
Nodes (7): cyclictest_idle_cpu11, max_us, p50_us, p95_us, p999_us, p99_us, samples
...
Cohesion: 0.07
Nodes (65): all_angles(), all_ratios(), Angle, bfs_backtrack(), Circle, circle_of_and_why(), Direction, get_circles_thru_all() (+57 more)

### Community 283 - "Community 283"
Cohesion: 0.04
Nodes (102): AggregateMode, BaseHypothesis, bool, float, ndarray, merge_feeds(), Align multi-symbol feeds on unified timeline (no lookahead)., K-way merge on local_ts; equal timestamps processed in symbol sort order. (+94 more)

### Community 284 - "Community 284"
Cohesion: 0.50
Nodes (3): Latency viability, Robustness, Workbench Run Report: HYP_5
...
Cohesion: 0.05
Nodes (109): campaign_preview(), _candidate_npz_symbols(), catalog_years_available(), list_campaign_events(), list_personal_events(), load_model_binding(), load_periods(), load_sim_shadow_config() (+101 more)
...
Cohesion: 0.05
Nodes (22): clone(), evaluateFieldPredicate(), evaluateFilter(), evaluateLogicalPredicate(), genId(), isFieldPredicate(), isLogicalPredicate(), MemoryStorageProvider (+14 more)
...
Cohesion: 0.09
Nodes (19): AuditQuery, tracer, after, before, clinician, from, makeDetail(), makeOperation() (+11 more)
...
Cohesion: 0.08
Nodes (24): error, evaluate_only, event_results, events_missing, events_run, expectancy, gate_pass, name (+16 more)
...
Cohesion: 0.22
Nodes (8): audit_grade, authority_refs, campaign_id, catalog_years_available, min_history_years_required, model_id, param_hash, symbol
...
Cohesion: 0.25
Nodes (7): campaign_id, model_id, param_hash, periods, promote_candidate, status, symbol

### Community 345 - "Community 345"
Cohesion: 0.08
Nodes (6): ang_between(), check_aconst(), random_points(), sketch_free(), sketch_segment(), NumericalTest

### Community 346 - "Community 346"
Cohesion: 0.48
Nodes (6): int, str, _calendar_rows(), _event_id(), _load_existing(), main()
...
Cohesion: 0.50
Nodes (4): _extract_hyp_bindings(), main(), int, str
...
Cohesion: 0.06
Nodes (55): canonical_params_json(), param_hash_from_dict(), Strategy parameter hashing and canonical serialization., _events_for_years(), _git_sha(), load_matrix_rows(), _npz_hash(), Full parameter-matrix IS/OOS backtest runner for WFC. (+47 more)
...
Cohesion: 0.11
Nodes (32): BeamQueue, check_valid_args(), get_lm(), insert_aux_to_premise(), main(), natural_language_statement(), proof_step_string(), Translate proof to natural language.    Args:     proof_step: pr.Dependency w (+24 more)

### Community 369 - "Community 369"
Cohesion: 0.11
Nodes (17): campaign_id, model_id, overfit_risk, param_hash, periods, promote_candidate, promote_note, robustness_passed (+9 more)
...
Cohesion: 0.05
Nodes (48): checkResponseSize(), createResponseTooLargeError(), createTimeoutError(), DEFAULT_CONFIG, ExecutionGuardConfig, withTimeout(), ComplexityAnalysis, ComplexityConfig (+40 more)
...
Cohesion: 0.15
Nodes (12): generated_at, llm_elapsed_s, llm_error, llm_model, llm_status, report_written, similar_runs_count, skip_reasons (+4 more)

### Community 405 - "Community 405"
Cohesion: 0.18
Nodes (10): authority_refs, estimated_cost_usd, events, max_cost_usd, missing_count, model_id, options_lane_discover, download_jobs (+2 more)

### Community 406 - "Community 406"
Cohesion: 0.20
Nodes (9): campaign_id, model_id, param_hash, periods, promote_candidate, promote_note, sim_shadow_required, status (+1 more)
...
Cohesion: 0.04
Nodes (45): RedpandaEventBus, RedpandaEventBusConfig, generateSubscriptionResolvers(), logger, ChangeEvent, ConnectionAuthenticator, ConnectionAuthResult, createFilteredSubscription() (+37 more)
...
Cohesion: 0.40
Nodes (4): evaluate_only, event_id, period, state
...
Cohesion: 0.11
Nodes (20): check_circle(), check_coll(), check_cong(), check_const_angle(), check_contri(), check_cyclic(), check_eqratio(), check_midp() (+12 more)
...
Cohesion: 0.04
Nodes (45): type, type, required, type, type, type, required, type (+37 more)
...
Cohesion: 0.10
Nodes (28): add_beam_dim(), add_beam_dim_cache(), apply_on_cache(), beam_init(), beam_search_flat(), BeamState, brevity_penalty(), flat_batch_beam_expand() (+20 more)
...
Cohesion: 0.36
Nodes (12): write_kg_slice(), Post-run after-action layer — OpenFoundry bridge, packet, symbolic, LLM., Any, bool, Path, str, diagnostics_model_id(), _load_config() (+4 more)

### Community 518 - "Community 518"
Cohesion: 0.06
Nodes (47): CdmRouterConfig, extractErrorCode(), mapCodeToCategory(), OpenFoundryErrorOptions, wrapError(), buildConnection(), decodeCursor(), encodeCursor() (+39 more)
...
Cohesion: 0.25
Nodes (7): After-Action Report for CME MBO Backtests, Edge Proposals (JSON Block), Packet Summary (Full Audit in Artifact JSON), PDF Citation Index, Similar Prior Runs, Summary of Results, Symbolic Result
...
Cohesion: 0.13
Nodes (28): collx_to_coll(), collx_to_coll_setup(), get_logs(), join_prems(), point_levels(), point_log(), Recursively traceback from the query, i.e. the conclusion., Convert collx to coll in setups. (+20 more)

### Community 527 - "Community 527"
Cohesion: 0.07
Nodes (25): Acknowledgements, Citing this work, Code License, code:block1 (bash run.sh), code:shell (python -m alphageometry \), code:shell (...), code:block12 (bash run_tests.sh), code:bibtex (@Article{AlphaGeometryTrinh2024,) (+17 more)
...
Cohesion: 0.04
Nodes (115): Resolve replay NPZ paths for Rithmic trial vs Databento event windows., Return Databento MBO NPZ path for a macro event_id from events.csv., Return quarantined Rithmic trial replay NPZ for a capture session date., Return quarantined Rithmic trial replay NPZ for a capture session date., resolve_event_npz(), resolve_trial_npz(), Path, str (+107 more)

### Community 544 - "Community 544"
Cohesion: 0.13
Nodes (15): injection_sweep, 0, 100, 1000, 10000, 100000, 1000000, 2000 (+7 more)

### Community 545 - "Community 545"
Cohesion: 0.22
Nodes (22): Any, bool, float, int, Path, Series, str, _audit_complete() (+14 more)

### Community 546 - "Community 546"
Cohesion: 0.13
Nodes (15): latency_authority, authority, breakeven_us, cpp_hot_path_runtime_us, lane_measured, lane_pass, lane_required, latency_profitability_buffer_us (+7 more)
...
Cohesion: 0.21
Nodes (12): Computes attention over a sequence of inputs.      Args:       xs: input sequ, Update a stored keys/values slice for different-lengthed seqs in batch., Initialize decoder state for autoregressive generation.      Args:       sequ, Full transformer layer, with attention., Compute the next decoder state, and return keys,values to attend to.      The, slice_in_dim_1(), TransformerLayerGenerate, update_slice_in_dim_1() (+4 more)

### Community 549 - "Community 549"
Cohesion: 0.11
Nodes (20): Any, float, str, Lightweight required-field check (schema_v1.json mirror)., validate_packet_schema(), _chain_tolerance_us(), check_latency_invariants(), Deterministic latency invariant checks (AlphaGeometry neuro-symbolic pattern). (+12 more)

### Community 550 - "Community 550"
Cohesion: 0.31
Nodes (7): LanguageModelInference, Call the meliad model., Meliad wrapper for LM inference., MetricsOutput, int, ndarray, str

### Community 551 - "Community 551"
Cohesion: 0.05
Nodes (15): Message, MessageState, BatchEvalRequest, BatchEvalResponse, BatchEvalResult, file_cel_service_proto_init(), file_cel_service_proto_rawDescGZIP(), init() (+7 more)
...
Cohesion: 0.27
Nodes (13): _gcd(), map_symbol(), map_symbol_inv(), pretty(), pretty2a(), pretty2r(), pretty_angle(), pretty_nl() (+5 more)
...
Cohesion: 0.17
Nodes (5): ARTest, Test that AR can figure out triangles with 3 equal angles => each is pi/3., Test that AR can figure out incenter/excenter touchpoints are equidistant to mid, Test for update_groups., Test that AR can figure out bisector & ex-bisector are perpendicular.
...
Cohesion: 0.29
Nodes (6): DecoderOnlyLanguageModelGenerate, Generate an output sequence.      Args:       inputs: the same as argument to, Decoder only language modeling in inference mode., Any, ndarray, str
...
Cohesion: 0.21
Nodes (21): build_kg_slice(), ingest_run(), _load_net_pnl(), Any, float, int, Path, str (+13 more)
...
Cohesion: 0.25
Nodes (6): DecoderStackGenerate, Stack of transformer decoder layers., Return initial state for autoregressive generation., DStackDecoderState, Array, int
...
Cohesion: 0.29
Nodes (7): event_context, catalog_years, data_sufficient, event_id, event_state, event_state_heuristic, symbol

### Community 580 - "Community 580"
Cohesion: 0.29
Nodes (7): openfoundry_meta, asset_class, connector_id, schema_version, vendor_shas, alphageometry, openfoundry

### Community 581 - "Community 581"
Cohesion: 0.29
Nodes (6): pdf_citations, pdf_citations_complete, per_trade_audit, run_id, schema_version, skip_reasons

### Community 582 - "Community 582"
Cohesion: 0.29
Nodes (7): predictions_vs_outcomes, adverse_selection_ticks, signal_adjusted, signal_fill_direction_aligned_count, signal_fill_direction_aligned_ratio, signal_raw, trades_vetoed_by_defense
...
Cohesion: 0.40
Nodes (4): Code reviews, Community Guidelines, Contributor License Agreement, How to Contribute

### Community 590 - "Community 590"
Cohesion: 0.08
Nodes (48): mapEncounterStatus(), mapEncounterToFhir(), mapPatientToFhir(), buildPatientFilter(), extractSearchFilterFields(), fhirHeaders(), FhirRequest, FhirResponse (+40 more)

### Community 592 - "Community 592"
Cohesion: 0.22
Nodes (7): code:bash (git submodule update --init vendor/openfoundry vendor/alphag), code:bash (git submodule update --init vendor/openfoundry vendor/alphag), Connector, hft3 adapter, OpenFoundry integration (hft3), OpenFoundry vendor stub, Vendor pins
...
Cohesion: 0.50
Nodes (3): obligations, passed, violations
...
Cohesion: 0.07
Nodes (23): ConnectorConfig, ExtractOptions, ConnectorFactory, ConnectorMetadata, ConnectorPlugin, connector, plugin, removed (+15 more)
...
Cohesion: 0.06
Nodes (44): actionToPermissionName(), buildActionsByTarget(), findLinkType(), generateOpenFGAModel(), generateOpenFGASchema(), generateTypeRelations(), getActionTargetType(), getOutboundLinks() (+36 more)

### Community 624 - "Community 624"
Cohesion: 0.04
Nodes (45): Action Manifests, Boot Sequence, code:block1 (my-pack/), code:yaml (api-gateway:), code:bash (docker compose up -d api-gateway), code:yaml (domainPacksExtra:), code:yaml (domainPacksExtra:), code:bash (curl http://localhost:4000/admin/packs | jq .) (+37 more)

### Community 625 - "Community 625"
Cohesion: 0.04
Nodes (45): Appendix A — Items the Open Foundry team must fill in before submission, code:text (Baseline source:           github.com/syzygyhack/open-foundr), code:text (Verification commands:), code:text (Option A — Trust-controlled cloud tenant), code:text (Mode A — Real source data, read-only), code:text (Conformance test inputs:), code:text (Open Foundry's Stage 1 IG layer does NOT claim:), code:text (Incident response:) (+37 more)

### Community 626 - "Community 626"
Cohesion: 0.07
Nodes (34): extractContext(), getSpanContext(), getSpanId(), getTraceId(), HeaderCarrier, injectContext(), PropagationHeaders, withContext() (+26 more)

### Community 627 - "Community 627"
Cohesion: 0.09
Nodes (35): createCdmRouter(), createFhirRouter(), buildResolverContext(), createGraphQLServer(), ActionAuthzMapping, createFgaClient(), createSecurityLayer(), extractUser() (+27 more)
...
Cohesion: 0.05
Nodes (38): admittedTo, badDir, consultant, coreInfo, dir1, dir2, __dirname, DOMAIN_PACKS_DIR (+30 more)

### Community 632 - "Community 632"
Cohesion: 0.11
Nodes (15): CdcConsumer, CdcConsumerConfig, CdcStats, ChangeApplier, CheckpointStore, logger, config, failConsumer (+7 more)
...
Cohesion: 0.10
Nodes (5): ConsentService, EventCause, LinkManager, ObjectManager, withSpan()

### Community 635 - "Community 635"
Cohesion: 0.16
Nodes (25): aggregateObjects(), tableName(), composeFragments(), fieldPredicateToSql(), filterToSql(), isFieldPredicate(), isLogicalPredicate(), logicalPredicateToSql() (+17 more)

### Community 636 - "Community 636"
Cohesion: 0.10
Nodes (32): BOOLEAN_FILTER_OPS, BUILTIN_SCALARS, collectFilterEnumNames(), CUSTOM_SCALARS, fieldToGqlType(), generateChangeEvent(), generateConnection(), generateCustomScalars() (+24 more)

### Community 637 - "Community 637"
Cohesion: 0.07
Nodes (59): buildConfig(), buildConnection(), buildLink(), buildMapping(), buildPrimaryKey(), buildProperties(), buildSync(), ConflictResolution (+51 more)
...
Cohesion: 0.13
Nodes (20): RollbackPolicy, SideEffect, SideEffectExecutor, CloudEvent, CloudEventConfig, EventBus, HttpClient, HttpRequestOptions (+12 more)

### Community 640 - "Community 640"
Cohesion: 0.06
Nodes (31): actionResult, afterCursor, aggregateMock, batchRedactMock, checkMock, conn, createMockUser(), createResolverContext() (+23 more)

### Community 641 - "Community 641"
Cohesion: 0.11
Nodes (14): EventBus, InMemoryEventBus, ChangeSet, EngineEventEmitter, generateEventId(), LinkEventData, ObjectEventData, ctx (+6 more)
...
Cohesion: 0.06
Nodes (29): actionFiles, combinedSource, computed, config, connPath, constraint, content, createObj (+21 more)
...
Cohesion: 0.06
Nodes (28): actionFiles, combinedSource, computed, config, connPath, constraint, content, createObj (+20 more)

### Community 651 - "Community 651"
Cohesion: 0.11
Nodes (29): ManifestRegistry, main(), compareSemver(), ConnectorManifest, convertObjectType(), discoverPacks(), discoverPacksFromPath(), loadDomainPacks() (+21 more)

### Community 652 - "Community 652"
Cohesion: 0.11
Nodes (26): cardinalityValues, errs, paramErr, result, schema, warns, BUILTIN_COMPUTE_FNS, BUILTIN_SCALARS (+18 more)

### Community 653 - "Community 653"
Cohesion: 0.11
Nodes (16): fiftyPatients, ids, manyPatients, noExemption, PatientRecord, PATIENTS, record, Tuple (+8 more)

### Community 654 - "Community 654"
Cohesion: 0.07
Nodes (28): dependencies, @grpc/grpc-js, @grpc/proto-loader, @openfoundry/observability, @openfoundry/odl, @openfoundry/spi, yaml, description (+20 more)

### Community 655 - "Community 655"
Cohesion: 0.12
Nodes (24): fieldToTsType(), generateActionInputInterface(), generateActionResultType(), generateActionsNamespace(), generateClientClass(), generateConnectionType(), generateEnums(), generateFilterInterface() (+16 more)

### Community 656 - "Community 656"
Cohesion: 0.07
Nodes (28): Action Pipeline Footguns (end-to-end), Authorization Tuples for Actions, Boot ordering: create the OpenFGA store *before* api-gateway, code:bash (# 1. Copy environment config and set passwords), code:bash (GIT_REVISION=$(git rev-parse HEAD) docker compose up -d --bu), code:bash (docker compose down        # Stop services (keep data)), code:bash (# 1. Start dependencies only (not api-gateway)), code:block3 (Schema migration: version 1 already applied but DDL checksum) (+20 more)

### Community 657 - "Community 657"
Cohesion: 0.13
Nodes (17): IdentityConflictEvent, IdentityResolutionResult, IdentityResolver, IdentityResolverConfig, IdentityStore, QualityViolation, QuarantineInput, QuarantineQueryFilter (+9 more)

### Community 658 - "Community 658"
Cohesion: 0.10
Nodes (13): hashValue(), InMemoryLineageStore, LineageQueryOptions, LineageRecorder, LineageRecorderConfig, LineageStore, ctx, evaluator (+5 more)

### Community 659 - "Community 659"
Cohesion: 0.10
Nodes (22): data, jsonDir, jsonFiles, { outputDir, config }, sqlDir, sqlPath, DEFAULT_CONFIG, GeneratorConfig (+14 more)

### Community 660 - "Community 660"
Cohesion: 0.14
Nodes (14): ConflictEventData, ConflictEventHandler, ConflictResolutionResult, ConflictResolver, ConflictResolverConfig, ConflictStrategy, ExistingValue, FieldResolution (+6 more)

### Community 661 - "Community 661"
Cohesion: 0.07
Nodes (27): 5.1.1 Action Versioning, 5.1 Action Manifest, 5.2.1 CEL Environment, 5.2.2 Null Propagation, 5.2.3 Type System, 5.2.4 CEL Runtime Strategy, 5.2 Expression Language, 5.3 Execution Pipeline (+19 more)
...
Cohesion: 0.08
Nodes (42): Any, float, int, str, Any, PaperLatencyRecordV1, Path, str (+34 more)

### Community 664 - "Community 664"
Cohesion: 0.08
Nodes (26): dependencies, @opentelemetry/api, @opentelemetry/exporter-trace-otlp-http, @opentelemetry/sdk-metrics, @opentelemetry/sdk-node, @opentelemetry/sdk-trace-base, pino, description (+18 more)

### Community 666 - "Community 666"
Cohesion: 0.08
Nodes (26): dependencies, @openfoundry/observability, @openfoundry/spi, pg, yaml, description, devDependencies, @types/node (+18 more)

### Community 667 - "Community 667"
Cohesion: 0.07
Nodes (26): active, activeIds, activePatients, bed, bedAssignments, bedIds, consultantIds, data (+18 more)

### Community 668 - "Community 668"
Cohesion: 0.08
Nodes (25): dependencies, @openfoundry/observability, @openfoundry/odl, @openfoundry/spi, description, devDependencies, @openfoundry/storage-memory, @types/node (+17 more)
...
Cohesion: 0.08
Nodes (24): bin, odl, dependencies, commander, graphql, description, devDependencies, @openfoundry/spi (+16 more)

### Community 675 - "Community 675"
Cohesion: 0.08
Nodes (24): dependencies, jose, @openfga/sdk, @openfoundry/observability, @openfoundry/spi, description, devDependencies, @types/node (+16 more)

### Community 676 - "Community 676"
Cohesion: 0.15
Nodes (22): getBedTypesForSpecialty(), resetIds(), DISCHARGE_NOTES, FIRST_NAMES, LAST_NAMES, WARD_NAME_PREFIXES, WARD_SPECIALTIES, AdmittedToLink (+14 more)
...
Cohesion: 0.08
Nodes (24): dependencies, @openfoundry/observability, @openfoundry/odl, @openfoundry/spi, pg, description, devDependencies, @types/node (+16 more)
...
Cohesion: 0.09
Nodes (22): dependencies, @openfoundry/actions, @openfoundry/api, @openfoundry/odl, @openfoundry/security, @openfoundry/spi, @openfoundry/storage-memory, @openfoundry/sync (+14 more)
...
Cohesion: 0.09
Nodes (21): compilerOptions, composite, declaration, declarationMap, esModuleInterop, exactOptionalPropertyTypes, forceConsistentCasingInFileNames, incremental (+13 more)
...
Cohesion: 0.10
Nodes (21): dependencies, @openfoundry/spi, description, devDependencies, @openfoundry/storage-memory, vitest, exports, files (+13 more)

### Community 686 - "Community 686"
Cohesion: 0.10
Nodes (20): API Specification Artifacts, Artifacts, AsyncAPI (any language), CI Release Workflow, code:bash (# Build first (CLIs run from dist/)), code:bash (DOMAIN_PACKS=core,nhs-acute pnpm --filter @openfoundry/api s), code:bash (openapi-generator-cli generate \), code:bash (# Using openapi-generator) (+12 more)

### Community 687 - "Community 687"
Cohesion: 0.16
Nodes (12): PostgresSchemaRegistry, breakingSchema(), emptySchema(), field(), objectType(), pool, reader, reg (+4 more)

### Community 688 - "Community 688"
Cohesion: 0.10
Nodes (19): 11.1 SPI Conformance Suite, 11.2 Integration Test Harness, 11.3 Action Conformance, 11.4 API and App Conformance, 11. Testing and Conformance, 13.1 Performance Targets, 13.2 Scalability Targets, 13.3 Security Requirements (+11 more)

### Community 689 - "Community 689"
Cohesion: 0.10
Nodes (19): description, devDependencies, turbo, typescript, engines, node, license, name (+11 more)

### Community 690 - "Community 690"
Cohesion: 0.11
Nodes (19): dependencies, @openfoundry/spi, description, devDependencies, vitest, exports, files, import (+11 more)
...
Cohesion: 0.10
Nodes (19): admitPath, body, components, content, __dirname, DOMAIN_PACKS_DIR, filterParams, get (+11 more)

### Community 693 - "Community 693"
Cohesion: 0.11
Nodes (18): 7.1 Patient Lifecycle, 7.2 Permissions, 7.3 Consent, 7.4 Audit, 7.5 FHIR, 7.6 Sync, 7.7 Sync Conflict Resolution, 7.8 Identity Resolution (+10 more)

### Community 694 - "Community 694"
Cohesion: 0.11
Nodes (19): 4.1 Responsibilities, 4.2.1 Event Ordering Guarantees, 4.2 Event Format, 4.3 Validation Pipeline, 4.4.1 Evaluation Strategies, 4.4.2 Dependency Tracking for EAGER Fields, 4.4.3 Cache Interface, 4.4 Computed Field Cache Invalidation (+11 more)

### Community 695 - "Community 695"
Cohesion: 0.11
Nodes (18): dependsOn, outputs, cache, globalDependencies, dependsOn, outputs, $schema, tasks (+10 more)

### Community 696 - "Community 696"
Cohesion: 0.25
Nodes (18): generate(), generateAdmittedToLinks(), generateBeds(), generateConsultants(), generateDischargeRecords(), generateOccupiesBedLinks(), generatePatients(), generateUnderCareOfLinks() (+10 more)
...
Cohesion: 0.11
Nodes (17): description, devDependencies, @types/node, vitest, license, name, private, scripts (+9 more)

### Community 701 - "Community 701"
Cohesion: 0.11
Nodes (17): description, devDependencies, tsx, @types/node, typescript, vitest, license, name (+9 more)

### Community 702 - "Community 702"
Cohesion: 0.12
Nodes (17): description, devDependencies, vitest, exports, files, import, license, main (+9 more)

### Community 703 - "Community 703"
Cohesion: 0.06
Nodes (30): actionResult, admitAction, aggregateMock, AnyBody, body, checkMock, createMockRequest(), createMockUser() (+22 more)

### Community 704 - "Community 704"
Cohesion: 0.12
Nodes (16): AdmittedTo (link) → CDM `Encounter`, API, Bed → CDM `Location` (kind=bed), code:json ({), Compatibility matrix, Consultant → CDM `Practitioner`, DischargeRecord → CDM `Discharge`, FDP/CDM Compatibility Profile (S1.0) (+8 more)

### Community 705 - "Community 705"
Cohesion: 0.12
Nodes (17): 6.1 Connector Interface, 6.2.1 Pull-Based Consumption, 6.2.2 Rate Limiting, 6.2.3 Circuit Breaker, 6.2.4 Initial Full Extract, 6.2 Backpressure and Flow Control, 6.3 Datasource Mapping, 6.4.1 Overlay Semantics (+9 more)

### Community 706 - "Community 706"
Cohesion: 0.12
Nodes (17): 8.2.1 Aggregate Health Endpoint, 8.2 REST API, 8.3 FHIR R4 API, 8.4 Client SDKs, 8.5 Application Framework, 8.6 Webhook Integrations, 8.7 API Governance and Quotas, 8.8 Unified Error Model (+9 more)

### Community 707 - "Community 707"
Cohesion: 0.12
Nodes (11): Connector, CacheEntry, OverlayEngine, OverlayEngineConfig, OverlayLineage, OverlayObject, config, defaultEngine (+3 more)
...
Cohesion: 0.22
Nodes (8): bool, Path, str, main(), Master offline orchestrator (pre-bare-metal): probe download -> convert -> resea, Generate 44 per-hypothesis research cards + HftBacktest combined replay + fills, Per-hypothesis SignalBacktester matrix. HftBacktest combined is opt-in (skip_hft, run_all_research_cards()

### Community 710 - "Community 710"
Cohesion: 0.13
Nodes (15): description, exports, files, import, license, main, name, scripts (+7 more)

### Community 711 - "Community 711"
Cohesion: 0.13
Nodes (14): description, devDependencies, @openfoundry/actions, @openfoundry/odl, @types/node, vitest, yaml, name (+6 more)

### Community 712 - "Community 712"
Cohesion: 0.14
Nodes (12): connector, extractPromise, initConnector(), iter, makeConfig(), mockConnect, mockEnd, MockPool (+4 more)

### Community 713 - "Community 713"
Cohesion: 0.13
Nodes (15): 3.1 SPI Operations, 3.2 Key Types, 3.3 Soft-Delete Semantics, 3.4 Transaction Semantics, 3.5 Optimistic Concurrency, 3.6 Replication Requirements, 3.7 Provider Implementations, 3.8 Bulk Mutation Contract (+7 more)

### Community 714 - "Community 714"
Cohesion: 0.13
Nodes (15): 7.2.1 Audit Query API, 7.2 Audit Trail, 7.3.1 Consent in the Query Pipeline, 7.3.2 Consent in the Action Pipeline, 7.3.3 Direct Care Exemption, 7.3.4 Consent Revocation, 7.3 Consent Management, 7.4 Authentication (+7 more)
...
Cohesion: 0.21
Nodes (9): getObjectAtTime(), getObjectAtVersion(), historyRowToObject(), historyTableName(), ctx, pool, queryFn, row (+1 more)

### Community 718 - "Community 718"
Cohesion: 0.14
Nodes (14): 2.2.1 CodeableConcept, 2.2 Scalar Types, 2.4 Namespaces, 2.5.1 Schema Rollback, 2.5.2 Data Migration Plans, 2.5 Schema Lifecycle, 2.6 Schema Workspaces, 2. Ontology Definition Language (ODL) (+6 more)

### Community 719 - "Community 719"
Cohesion: 0.14
Nodes (12): coreOdlPath, coreOdlSource, __dirname, fieldNames, names, PACK_ROOT, packYamlContent, packYamlPath (+4 more)
...
Cohesion: 0.15
Nodes (12): description, devDependencies, @openfoundry/odl, @types/node, vitest, name, private, scripts (+4 more)
...
Cohesion: 0.17
Nodes (12): 9.1 Instance Identity, 9.2 Data Sharing Agreements, 9.3.1 Pagination, 9.3 Cross-Instance Query, 9.4 Federated Aggregation, 9.5.1 Handoff Conflict Resolution, 9.5 Object Handoff, 9. Federation Protocol (+4 more)
...
Cohesion: 0.17
Nodes (12): Architecture, code:graphql (type Asset @objectType {), Design Principles, Documentation, License, ODL Schema Example, Open Foundry, PostgreSQL Capabilities (+4 more)

### Community 727 - "Community 727"
Cohesion: 0.27
Nodes (10): calculateCheckDigit(), generateNhsNumber(), generateUniqueNhsNumbers(), isValidNhsNumber(), WEIGHTS, check, lastDigit, num (+2 more)

### Community 728 - "Community 728"
Cohesion: 0.17
Nodes (10): bedNumbers, betweenTime, caps, config, ctx, filter, path, patientFilter (+2 more)

### Community 729 - "Community 729"
Cohesion: 0.30
Nodes (11): a, b, emptySchema(), field(), objectType(), orderAB, orderBA, reg (+3 more)

### Community 730 - "Community 730"
Cohesion: 0.17
Nodes (7): options, path, pool, queriedParams, QueryResponder, QueryResult, steps
...
Cohesion: 0.49
Nodes (10): init-services.sh script, dc_psql(), err(), init_age(), load_domain_schema(), load_openfga_model(), log(), main() (+2 more)

### Community 733 - "Community 733"
Cohesion: 0.18
Nodes (10): 10. Risk Register, 11. Go / No-Go Gates, 12. Success Criteria, 1. Purpose, 3.1 Monorepo Structure (MVP Scope), 3. Technology Stack, 8. Performance Targets (MVP), 9. What This Enables Next (+2 more)
...
Cohesion: 0.18
Nodes (11): code:bash (pnpm install), code:bash (# Unit tests (all packages except integration)), code:bash (cd deploy), code:bash (helm install openfoundry deploy/helm/openfoundry \), Getting Started, Install and Build, Kubernetes Deployment, Local Development Stack (+3 more)
...
Cohesion: 0.22
Nodes (9): 2.3.1 `@searchable` Directive Semantics, 2.3.2 `@constraint` Directive Semantics, 2.3.3 `@immutable` Directive Semantics, 2.3 Directives Reference, code:graphql (type Patient @objectType {), code:graphql (type Ward @objectType {), code:graphql (type TheatreSlot @objectType @constraint(expr: "this.endTime), code:graphql (type WaitingListEntry @objectType) (+1 more)

### Community 743 - "Community 743"
Cohesion: 0.22
Nodes (9): 7.1.1 Authorisation Model, 7.1.2 Permission Levels, 7.1.3 Field-Level Security Behaviour, 7.1.4 Permission Evaluation, 7.1.5 Permission Check Batching, 7.1.6 Security Layer Circuit Breaker, 7.1 Access Control Model, code:block43 (model) (+1 more)
...
Cohesion: 0.25
Nodes (8): 8.1.1 Generated Query Types, 8.1.2 Generated Mutation Types, 8.1.3 FHIR Mapping for Mutations, 8.1.4 Generated Subscription Types, 8.1.5 Search and Discovery, 8.1 Auto-Generated GraphQL API, code:graphql (type Query {), code:graphql (type Subscription {)

### Community 747 - "Community 747"
Cohesion: 0.25
Nodes (8): Action Framework, Deployment, Features, Governance & Resilience, Observability, Ontology Engine, Query & API, Security
...
Cohesion: 0.06
Nodes (66): mbo_predictive_r2(), ols_r2(), Predictive metrics for cross-asset MBO ablation (exploratory, not alpha)., R² for y ~ const + x columns; requires n > number of regressors., OLS R² of forward returns on MBO snapshot predictors at anchor offset.     One r, AblationResult, _feature_target_coupling_score(), Phase 8 — cross-asset MBO ablation harness (tests groups; does not assume alpha) (+58 more)

### Community 750 - "Community 750"
Cohesion: 0.57
Nodes (7): breakingSchema(), emptySchema(), field(), objectType(), schema, v1Schema(), v2Schema()

### Community 751 - "Community 751"
Cohesion: 0.29
Nodes (7): devDependencies, @types/cors, @types/express, @types/node, @types/ws, typescript, vitest
...
Cohesion: 0.35
Nodes (6): _closure(), Topological execution of PDF model dependencies with cached instances., Run only requested models plus dependency closure in topo order., _topo_sort(), Any, str
...
Cohesion: 0.29
Nodes (5): patient, patientA, patientB, records, updated

### Community 756 - "Community 756"
Cohesion: 0.33
Nodes (5): compilerOptions, declarationMap, sourceMap, exclude, extends
...
Cohesion: 0.33
Nodes (6): 5.1 Container Services (MVP), 5.2 Docker Compose (Development), 5.3 Production (Kubernetes / Helm), 5. Deployment Architecture, code:bash (docker compose up), code:bash (helm install nhs-pilot openfoundry/openfoundry \)

### Community 763 - "Community 763"
Cohesion: 0.33
Nodes (6): 1.1 What This Document Is, 1.2 Design Principles, 1.3 Architecture Summary, 1.4 Normative Language, 1. Overview, code:block1 (┌─────────────────────────────────────────────────────────┐)
...
Cohesion: 0.33
Nodes (4): edgeIds, patient, PatientRecord, patients
...
Cohesion: 0.15
Nodes (15): Ablation metrics, code:bash (python scripts/run_offline_pipeline.py --skip-download --eve), code:bash (python scripts/run_pdf_hybrid_replay.py --no-ofi --no-vpin  ), code:bash (python scripts/run_pdf_hybrid_ablation.py --event-id CPI_202), code:bash (python scripts/run_pdf_hybrid_replay.py --event-id CPI_2024_), code:bash (python scripts/run_event_replay.py --event-id CPI_2024_09_11), code:bash (pytest tests/backtest_pipeline/test_pdf_hybrid_strategy.py t), Defensive ablation (plug-and-play) (+7 more)

### Community 790 - "Community 790"
Cohesion: 0.40
Nodes (5): 6. Pilot Onboarding Workflow, Phase 1: Connect (Week 1-2), Phase 2: Activate (Week 3-4), Phase 3: Integrate (Week 5-6), Phase 4: Validate (Week 7-8)

### Community 791 - "Community 791"
Cohesion: 0.40
Nodes (5): Core Platform (`packages/`), Domain Packs (`domain-packs/`), Packages, Tests (`tests/`), Tools (`tools/`)

### Community 792 - "Community 792"
Cohesion: 0.50
Nodes (4): 2.1 Must Ship, 2.2 Deferred to Post-MVP, 2.3 Stubbed (Interface Present, Implementation Minimal), 2. Scope Boundary

### Community 793 - "Community 793"
Cohesion: 0.50
Nodes (4): 4.4.1 Source-of-Truth Policy, 4.4.2 Identity Resolution, 4.4 Connector Configuration, code:yaml (# connectors/pas-jdbc.yaml)

### Community 794 - "Community 794"
Cohesion: 0.50
Nodes (4): By the Numbers, How This Was Built, Phase 1: Cardinal, Phase 2: Human-Agent Collaboration

### Community 795 - "Community 795"
Cohesion: 0.50
Nodes (4): code:bash (# Load packs from one or more external directories (colon-se), Domain Packs, External Domain Packs, NHS Acute Pilot
...
Cohesion: 0.11
Nodes (25): bring_together(), check_eqangle(), check_para(), Line, line_line_intersection(), line_segment_intersection(), _perpendicular_bisector(), Sketch a circle touching two lines and another circle. (+17 more)
...
Cohesion: 0.04
Nodes (106): ABC, BookPressureOutput, CrossAssetLeadLagOutput, DowYMIndexOutput, Any, T, Any, bool (+98 more)
...
Cohesion: 0.17
Nodes (15): float, int, bessel_i0(), collapse_risk(), I_0(x) = (1/pi) integral_0^pi exp(x cos phi) dphi., a, b from liquidity components xi1, kappa1., P(Delta) = (1/(xi1*kappa1)) * Delta * exp(-a Delta^2) * I_0(b Delta^2).     Retu, Skew toward spread collapse when small-spread mass dominates. (+7 more)
...
Cohesion: 0.10
Nodes (53): _cfg(), _metric_dict(), _multi_fold_rows(), Tests for Walk Forward Correlation gate., Pooled (param×fold) correlation differs from per-parameter fold correlation., _rows(), _rows_negative_fold(), test_wfc_cost_adjusted_correlation_required() (+45 more)
...
Cohesion: 0.14
Nodes (26): Config-driven options fee model for parity arb., datetime, collect_download_specs(), discover_groups(), download_leg_window(), Budget-gated Databento download for options parity legs., Return unique download jobs from parity universe (no hardcoded symbols)., Download one leg via DatabentoResearchClient budget gate.     Requires DATABENTO (+18 more)
...
Cohesion: 0.06
Nodes (75): Popen, get_job_status(), job_dir_for(), list_active_campaigns(), Background campaign jobs with cooperative pause/stop., set_control(), start_campaign_subprocess(), Tests for workbench UI flow_state helpers. (+67 more)
...
Cohesion: 0.07
Nodes (28): data_delay_status, last_update_age_ms, 6C, HG, MCL, MGC, MNQ, ZL (+20 more)
...
Cohesion: 0.12
Nodes (17): end_year, events, start_year, end_year, events, start_year, end_year, events (+9 more)

### Community 1048 - "Community 1048"
Cohesion: 0.35
Nodes (9): Hypothesis 5: Spread blowout/recompression, SpreadBlowoutRecompression, load_chi404_speed(), main(), Any, int, Path, str (+1 more)
...
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, YM, ZF, ZS, feed_status (+8 more)
...
Cohesion: 0.11
Nodes (17): asyncapiChannels, channel, channels, doc, DOMAIN_PACKS_DIR, methodObj, msg, name (+9 more)
...
Cohesion: 0.07
Nodes (49): Any, bool, datetime, DefensiveConfig, float, int, MBOEvent, str (+41 more)
...
Cohesion: 0.11
Nodes (17): changeType, channel, channels, components, __dirname, DOMAIN_PACKS_DIR, idParam, message (+9 more)
...
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, data_delay_status, last_update_age_ms, 6A, ES, M2K, ZF (+8 more)

### Community 1436 - "Community 1436"
Cohesion: 0.25
Nodes (14): actionInputSchema(), actionPath(), generateOpenApiSpec(), isComputed(), isLink(), isParam(), isPrimary(), lowerFirst() (+6 more)
...
Cohesion: 0.46
Nodes (5): changeEventSchema(), generateAsyncApiSpec(), lowerFirst(), main(), readPlatformVersion()
...
Cohesion: 0.15
Nodes (19): Any, float, int, PaperLatencyRecordV1, Path, str, TrialConfig, bool (+11 more)

### Community 1523 - "Community 1523"
Cohesion: 0.07
Nodes (28): data_delay_status, last_update_age_ms, 6C, GC, HO, M2K, MES, UB (+20 more)
...
Cohesion: 0.67
Nodes (3): data_delay_status, last_update_age_ms, 6C

### Community 1528 - "Community 1528"
Cohesion: 0.67
Nodes (3): data_delay_status, last_update_age_ms, 6E

### Community 1529 - "Community 1529"
Cohesion: 0.67
Nodes (3): data_delay_status, last_update_age_ms, 6J
...
Cohesion: 0.67
Nodes (3): GC, data_delay_status, last_update_age_ms
...
Cohesion: 0.67
Nodes (3): SI, data_delay_status, last_update_age_ms
...
Cohesion: 0.67
Nodes (3): data_delay_status, last_update_age_ms, ES
...
Cohesion: 0.20
Nodes (20): Any, int, PaperLatencyRecordV1, Path, str, Any, int, Path (+12 more)
...
Cohesion: 0.15
Nodes (12): audit_grade, authority_refs, campaign_id, catalog_years_available, composition, defensive_stubs, primary_model_id, min_history_years_required (+4 more)
...
Cohesion: 0.40
Nodes (4): chi404_paper_roundtrip_run.sh script, RITHMIC_TRIAL_CONNECTOR, RITHMIC_TRIAL_ENABLED, RTRADER_WATCH_DIRS
...
Cohesion: 0.10
Nodes (19): campaign_id, events_ran, model_id, overfit_risk, param_hash, periods, promote_candidate, promote_note (+11 more)
...
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, ZB, ZF, ZT, feed_status (+8 more)

### Community 1892 - "Community 1892"
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MNQ, ZF, ZS, ZT, feed_status (+8 more)

### Community 1893 - "Community 1893"
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, ZB, ZM, ZQ, feed_status (+8 more)

### Community 1894 - "Community 1894"
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, ZB, ZQ, ZS, feed_status (+8 more)
...
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, ZC, ZS, ZT, feed_status (+8 more)
...
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, MGC, ZF, ZS, ZT, feed_status (+8 more)

### Community 1899 - "Community 1899"
Cohesion: 0.12
Nodes (16): data_delay_status, last_update_age_ms, 6A, HG, NQ, ZL, ZT, data_delay_status (+8 more)
...
Cohesion: 0.13
Nodes (14): audit_grade, authority_refs, campaign_id, catalog_years_available, composition, defensive_stubs, primary_model_id, min_history_years_required (+6 more)
...
Cohesion: 0.17
Nodes (11): Catalog vs runnable, code:block1 (events.csv → Databento GLBX.MDP3 MBO → data/npz/ → workbench), code:bash (python workbench/scripts/backfill_catalog.py --model HYP_5 -), code:bash (python workbench/scripts/backfill_catalog.py --model HYP_5 -), ES fallback (pre-MES listing), Keys, Keys (already configured), Lane (+3 more)
...
Cohesion: 0.13
Nodes (12): bool, datetime, float, int, datetime, str, BudgetManager, Calculates exact per-symbol-minute and per-symbol-second costs as required by Bl (+4 more)

### Community 1982 - "Community 1982"
Cohesion: 0.33
Nodes (5): chi404_fast_market_sweep.sh script, PAPER_LATENCY_RUN_ID, RITHMIC_TRIAL_CONNECTOR, RITHMIC_TRIAL_ENABLED, RTRADER_WATCH_DIRS

### Community 1983 - "Community 1983"
Cohesion: 0.33
Nodes (5): chi404_host_paper_sweep_orchestrator.sh script, PAPER_LATENCY_RUN_ID, RITHMIC_TRIAL_CONNECTOR, RITHMIC_TRIAL_ENABLED, RTRADER_WATCH_DIRS
...
Cohesion: 0.33
Nodes (6): avg_us, count, max_us, min_us, p99_us, order_submit_to_ack_us

### Community 1993 - "Community 1993"
Cohesion: 0.14
Nodes (8): _check_between(), check_sameside(), circle_segment_intersect(), InvalidLineIntersectError, Whether a is between b & c., HoleCircle, Circle, Line
...
Cohesion: 0.40
Nodes (5): limit_us, max_p99_us, reason, status, chi404_kernel_jitter
...
Cohesion: 0.11
Nodes (17): backfill, budget_cap_usd, budget_spent_usd, downloaded_event_ids, symbols, dry_run, downloaded, estimated_cost_usd (+9 more)
...
Cohesion: 0.50
Nodes (3): Blockers before claiming Phase 8/9 PASS, HFC3 Phase 10 — acceptance status, Next operational steps
...
Cohesion: 0.24
Nodes (9): Post-WFC robust plateau selection (runs only after WFC PASS)., Pick stable high-IS params; IS-only (no OOS metrics for final selection)., select_robust_plateau(), IS-only plateau selection (no OOS leakage)., test_plateau_matrix_rows_excludes_plateau_exclude_folds(), test_plateau_selector_aggregates_is_across_folds(), test_plateau_selector_ignores_oos_metrics(), Any (+1 more)

### Community 2455 - "Community 2455"
Cohesion: 0.47
Nodes (4): int, LegQuote, ParityGroup, QuoteSnapshot
...
Cohesion: 0.29
Nodes (7): order_path, bottleneck, dominant_rtt_ms, recommendation, recommended_latency_bands_ms, tier_ms, tier_name

### Community 2465 - "Community 2465"
Cohesion: 0.33
Nodes (5): C++ latency profile (µs), Latency viability, Robustness, Runtime (do not conflate), Workbench Run Report: HYP_1
...
Cohesion: 0.27
Nodes (4): EndOfDayForcedFlatten, FridayWeekendDerisking, Hypothesis 29: End-of-day forced flatten flow, Hypothesis 37: Friday/weekend de-risking
...
Cohesion: 0.40
Nodes (3): chi404_run_paper_sweep_direct.sh script, PAPER_LATENCY_RUN_ID, PAPER_LATENCY_TARGET_ORDERS
...
## Knowledge Gaps
- **18861 isolated node(s):** `bool`, `str`, `Path`, `Any`, `str` (+18856 more)
...
- **Why does `datetime` connect `Community 963` to `Community 1`, `Community 517`, `Community 9`, `Community 17`, `Community 1048`, `Community 283`, `Community 543`, `Community 291`, `Community 2424`, `Community 170`, `Community 1981`, `Community 73`, `Community 1362`, `Community 84`, `Community 1771`, `Community 749`, `Community 112`, `Community 1522`, `Community 1013`, `Community 248`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `Exception` connect `Community 282` to `Community 963`, `Community 1993`, `Community 525`, `Community 182`, `Community 119`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `EventSpec` connect `Community 119` to `Community 282`, `Community 291`, `Community 699`?**
...
- **Are the 71 inferred relationships involving `ModelComposition` (e.g. with `CatalogEntry` and `CompositionTrace`) actually correct?**
  _`ModelComposition` has 71 INFERRED edges - model-reasoned connections that need verification._
