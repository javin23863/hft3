...
3. `str` - 12 edges
4. `Path` - 12 edges
5. `Discovery` - 10 edges
6. `Confirmation` - 10 edges
7. `Holdout` - 10 edges
8. `Recent holdout` - 10 edges
9. `Path` - 10 edges
...
Cohesion: 0.29
Nodes (12): ES.v.0, ES.v.0, ES.v.0, npz_ready, pct_ready, total_events, error, npz_ready (+4 more)
