...
METRIC_UNITS: dict[str, str] = {
    ...
    "tick_to_send_trigger_us": "us",
    "decision_to_send_trigger_us": "us",
    "tick_to_send_us": "us",
    "decision_to_send_us": "us",
    "rithmic_send_call_us": "us",
    ...
    metrics.update(
        {
            ...
            "tick_to_send_trigger_us": finite_or_none(execution.get("tick_to_send_trigger_us")),
            "decision_to_send_trigger_us": finite_or_none(execution.get("decision_to_send_trigger_us")),
            ...
            "rithmic_send_call_us": finite_or_none(execution.get("rithmic_send_call_us")),
