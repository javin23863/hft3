...
def run_inputs_from_run_dir(run_dir: Path) -> dict[str, Any]:
    ...
    execution = {
        ...
        "tick_to_send_trigger_us": _latency_us(latency_operating_envelope, ("offensive", "placement", "tick_to_send_trigger_us")),
        "decision_to_send_trigger_us": _latency_us(latency_operating_envelope, ("offensive", "placement", "decision_to_send_trigger_us")),
        ...
        "rithmic_send_call_us": _latency_us(latency_operating_envelope, ("offensive", "placement", "rithmic_send_call_us")),
