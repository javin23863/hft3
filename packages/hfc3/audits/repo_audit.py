...
try:
    from economic_event_universe.registry import required_event_types as _eu_required
except ImportError:
    _eu_required = lambda: []  # type: ignore[misc, assignment]
...
REQUIRED_EVENT_TYPES = sorted(set(_eu_required()) | set(_LEGACY_EXTRA))
