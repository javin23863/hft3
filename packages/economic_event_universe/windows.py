...
from economic_event_universe.registry import default_snapshot_offsets, get_event_def
...
def download_window(event_type: str) -> tuple[int, int]:
    ...
    return int(win.get("start_offset_seconds", -30)), int(win.get("end_offset_seconds", 300))
