...
def deploy_model(
    ...
    *,
    ...
    result_payload = {
        ...
        "evaluation": {
            "gross_pnl": eval_result.gross_pnl,
            "net_pnl": eval_result.net_pnl,
            "cost_total": eval_result.cost_total,
            ...
            "psr": eval_result.psr,
            "dsr": eval_result.dsr,
            "adjusted_p_value": eval_result.adjusted_p_value,
            "pbo": eval_result.pbo,
            "sample_size_pass": eval_result.sample_size_pass,
            "required_sample_size": eval_result.required_sample_size,
            "cvar_95": eval_result.cvar_95,
            "cvar_99": eval_result.cvar_99,
            "tail_ratio": eval_result.tail_ratio,
    ...
    md_lines = [
        ...
        f"**Gross PnL:** {(eval_result.gross_pnl if eval_result.gross_pnl is not None else eval_result.net_pnl):.4f}",
        f"**Net PnL:** {eval_result.net_pnl:.4f}",
        f"**Costs:** {eval_result.cost_total:.4f}",
        f"**PSR:** {eval_result.psr if eval_result.psr is not None else 'n/a'}",
        f"**DSR:** {eval_result.dsr if eval_result.dsr is not None else 'n/a'}",
